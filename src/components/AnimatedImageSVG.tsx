...
const AnimatedImageSVG = ({ width, height }: ImageProps) => {
  return (
    <svg
      ...
      width={width}
      height={height}
      viewBox="0 0 3162.0253164556957 3162.0253164556957"
    >
      <g transform="scale(8.10126582278481) translate(10, 10)">
        <defs id="SvgjsDefs3392">
          <linearGradient id="SvgjsLinearGradient3397">
            <stop id="SvgjsStop3398" stopColor="#fe8dc6" offset="0"></stop>
            <stop id="SvgjsStop3399" stopColor="#fed1c7" offset="1"></stop>
          </linearGradient>
          <linearGradient id="SvgjsLinearGradient3400">
            <stop id="SvgjsStop3401" stopColor="#fe8dc6" offset="0"></stop>
            <stop id="SvgjsStop3402" stopColor="#fed1c7" offset="1"></stop>
          </linearGradient>
        </defs>
        <g
          id="SvgjsG3393"
          // featurekey="rootContainer"
          transform="matrix(7.421091957441128,0,0,7.421091957441128,0,0)"
          fill="url(#SvgjsLinearGradient3397)"
        >
          <motion.path
            className="fill-current text-[#0D4373] dark:text-[#7AB9F0]"
            xmlns="http://www.w3.org/2000/svg"
            d="M24.95 48.63a23.68 23.68 0 1 1 23.68-23.68 23.7 23.7 0 0 1-23.68 23.68zm0-47a23.31 23.31 0 1 0 23.31 23.31 23.34 23.34 0 0 0-23.31-23.3z"
            initial={{
              rotate: 360,
              pathLength: 0,
              fillOpacity: 0,
          ...
          <motion.path
            className="fill-current text-[#0D4373] dark:text-[#7AB9F0]"
            xmlns="http://www.w3.org/2000/svg"
            d="M24.95 49.9A24.95 24.95 0 1 1 49.9 24.95 25 25 0 0 1 24.95 49.9zm0-49.53a24.58 24.58 0 1 0 24.58 24.58A24.61 24.61 0 0 0 24.95.37z"
            initial={{
              rotate: -360,
              pathLength: 0,
              fillOpacity: 0,
          ...
          <motion.path
            className="fill-current text-[#0D4373] dark:text-[#7AB9F0]"
            xmlns="http://www.w3.org/2000/svg"
            d="M24.95 47.43a22.48 22.48 0 1 1 22.48-22.48 22.5 22.5 0 0 1-22.48 22.48zm0-44.58a22.11 22.11 0 1 0 22.11 22.11A22.13 22.13 0 0 0 24.95 2.81z"
            initial={{
              pathLength: 0,
              fillOpacity: 0,
            }}
        ...
        <g
          ...
          transform="matrix(6.513993049486122,0,0,6.513993049486122,106,-7.520071540513101)"
          fill="url(#SvgjsLinearGradient3400)"
        >
          <motion.path
            className="fill-current text-[#0D4373] dark:text-[#7AB9F0]"
            d="M5.68 47.8 c-3.12 0 -5.68 -2.56 -5.68 -5.68 l3.8 0 c0 1 0.84 1.84 1.88 1.84 s1.88 -0.84 1.88 -1.84 l0 -24.8 l3.8 0 l0 24.8 c0 3.12 -2.56 5.68 -5.68 5.68 z M19.067 17.36 c2.84 0 5.16 2.28 5.16 5.12 l0 17.48 l-3.8 0 l0 -17.48 c0 -0.72 -0.6 -1.36 -1.36 -1.36 l-1.48 0 l0 18.84 l-3.8 0 l0 -28.52 l3.8 0 l0 5.92 l1.48 0 z"
            initial={{
              pathLength: 0,
              fillOpacity: 0,
            }}
